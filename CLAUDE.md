...
## Current State
- Steps 1–5 complete: data model (`FillUpEntry`), tab shell (`RootView`), entry form (`AddEntryView`), history screen (`HistoryView`, `EntryDetailView`), and stats screen (`StatsView`) are implemented.
